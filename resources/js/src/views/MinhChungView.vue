<template>
  <div class="m-4">
    ...
    <div class="card my-4 shadow-sm">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><i class="bi bi-cloud-upload me-2"></i>Upload Minh Chứng</h4>
          <button
            v-if="checkKetQua === false && !role"
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content border-0">
          ...
          <div class="modal-body p-4">
            <div
              class="upload-area p-4 rounded-3 border border-2 border-dashed"
            ...
            >
              <div class="text-center py-5">
                ...
                <p class="text-muted">
                  Hoặc nhấp vào nút bên dưới để chọn file từ máy tính của bạn
                </p>
    ...
    >
      <div
        class="toast show bg-white shadow-lg"
        role="alert"
        aria-live="assertive"
        aria-atomic="true"
      >
...
const getListMinhChung = () => {
  axios
    .get(`/api/minhchung/getlist/${maDeXuat}`, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("api_token")}`,
      },
    })
...
const downloadFile = (file) => {
  axios
    .get("/api/minhchung/download/" + file.PK_MaMinhChung, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("api_token")}`,
      },
...
const removeFile = (file) => {
  Swal.fire({
    ...
    axios
      .post(`/api/minhchung/delete/${file.PK_MaMinhChung}`, null, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("api_token")}`,
        },
      })
