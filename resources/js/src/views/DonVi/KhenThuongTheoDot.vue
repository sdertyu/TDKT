          ...
          <div class="card-body">
            <form @submit.prevent="submitForm">
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="soHuongDan" v-model="formData.soHuongDan" placeholder="Nhập số hướng dẫn">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="thoiGian">Vào hồi:</label>
                    <input type="datetime-local" class="form-control" id="thoiGian" v-model="formData.thoiGian">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="diaChi" v-model="formData.diaChi" placeholder="Nhập địa chỉ">
              </div>
              ...
              <div class="row mb-3">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="tongSoNguoi" v-model="formData.tongSoNguoi" min="0">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="soTrieuTap">Số người được triệu tập:</label>
                    <input type="number" class="form-control" id="soTrieuTap" v-model="formData.soTrieuTap" min="0">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="soCoMat">Số người có mặt:</label>
                    <input type="number" class="form-control" id="soCoMat" v-model="formData.soCoMat" min="0">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="soVang">Số người vắng:</label>
                    <input type="number" class="form-control" id="soVang" v-model="formData.soVang" min="0" disabled>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-select" id="chuTri" v-model="formData.chuTri">
                      ...
                      <option v-for="person in danhSachCaNhan" :key="person.id" :value="person.id">
                        {{ person.ten }}
                      </option>
                    </select>
                  </div>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-4">
                    ...
                    <div v-for="(person, index) in formData.caNhan.laoDongTienTien" :key="index" class="row mb-2 align-items-center">
                      <div class="col-md-6">
                        <select class="form-select" v-model="person.id">
                          <option value="" disabled selected>Chọn cá nhân</option>
                          <option v-for="p in danhSachCaNhan" :key="p.id" :value="p.id">{{ p.ten }}</option>
                        </select>
                      </div>
                      <div class="col-md-4">
                        <div class="input-group">
                          <input type="number" class="form-control" v-model="person.soPhieu" min="0" placeholder="Số phiếu bầu">
                          <span class="input-group-text">phiếu</span>
                        </div>
                      </div>
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger" @click="xoaCaNhan('laoDongTienTien', index)">
                          Xóa
                        </button>
                      </div>
                    </div>
                    <button type="button" class="btn btn-secondary mt-2" @click="themCaNhan('laoDongTienTien')">
                      Thêm cá nhân
                    </button>
                  </div>
                  ...
                  <div class="mb-4">
                    ...
                    <div v-for="(person, index) in formData.caNhan.chienSiThiDua" :key="index" class="row mb-2 align-items-center">
                      <div class="col-md-6">
                        <select class="form-select" v-model="person.id">
                          <option value="" disabled selected>Chọn cá nhân</option>
                          <option v-for="p in danhSachCaNhan" :key="p.id" :value="p.id">{{ p.ten }}</option>
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger" @click="xoaCaNhan('chienSiThiDua', index)">
                          Xóa
                        </button>
                      </div>
                    </div>
                    <button type="button" class="btn btn-secondary mt-2" @click="themCaNhan('chienSiThiDua')">
                      Thêm cá nhân
                    </button>
                  </div>
                  ...
                  <div class="mb-4">
                    ...
                    <div v-for="(person, index) in formData.caNhan.giayKhen" :key="index" class="row mb-2 align-items-center">
                      <div class="col-md-6">
                        <select class="form-select" v-model="person.id">
                          <option value="" disabled selected>Chọn cá nhân</option>
                          <option v-for="p in danhSachCaNhan" :key="p.id" :value="p.id">{{ p.ten }}</option>
                      ...
                      <div class="col-md-2">
                        <button type="button" class="btn btn-danger" @click="xoaCaNhan('giayKhen', index)">
                          Xóa
                        </button>
                      </div>
                    </div>
                    <button type="button" class="btn btn-secondary mt-2" @click="themCaNhan('giayKhen')">
                      Thêm cá nhân
                    </button>
                  </div>
                </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="number" class="form-control" v-model="formData.tapThe.soPhieu" min="0">
                            <span class="input-group-text">phiếu</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Số phiếu bầu:</label>
                          <div class="input-group">
                            <input type="number" class="form-control" v-model="formData.tapThe.giayKhen.soPhieu" min="0">
                            <span class="input-group-text">phiếu</span>
                          </div>
                        </div>
                      </div>
