...
ALTER TABLE `tblDanhHieu` ADD FOREIGN KEY (`FK_MaHinhThuc`) REFERENCES `tblHinhThucKhenThuong` (`PK_MaHinhThuc`);

ALTER TABLE `tblDanhHieu` ADD FOREIGN KEY (`FK_MaLoaiDanhHieu`) REFERENCES `tblLoaiDanhHieu` (`PK_MaLoaiDanhHieu`);

ALTER TABLE `tblHoiDong` ADD FOREIGN KEY (`FK_HinhThucHD`) REFERENCES `tblHinhThucHD` (`PK_HinhThucHD`);
